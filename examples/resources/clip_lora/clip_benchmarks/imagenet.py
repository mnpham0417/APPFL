...
class ImageNet:
    ...
    def __init__(
        self, root, num_shots, preprocess, train_preprocess=None, test_preprocess=None
    ):
        ...
        self.train_x = datasets.ImageFolder(
            os.path.join(os.path.join(self.dataset_dir, "train")),
            transform=train_preprocess,
        )
        self.val = datasets.ImageFolder(
            os.path.join(os.path.join(self.dataset_dir, "train")), transform=preprocess
        )
        self.test = datasets.ImageFolder(
            os.path.join(os.path.join(self.dataset_dir, "val")),
